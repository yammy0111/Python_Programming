...
def introduce(name,hometown,mbti="INTJ"):
    return f"나는 {name}이고, {hometown}에 살고, {mbti}이다."
...
def pocket_money(save:int, *args:int, **kwargs:int) -> int:
    return save + sum(args) + sum(kwargs.values())

save_money = 500
pick_money = 100, 200
given_money = {"dad":10000,"mom":5000}
print(pocket_money(save_money,*pick_money,**given_money))
pick_money = 100, 200, 300
given_money = {"dad":10000,"mom":5000, "uncle":100000}
print(pocket_money(save_money,*pick_money,**given_money))
